...
\begin{figure}[!t]
  ...
  \figurenote{This figure shows four demonstrated psychological non-linear
    processes. \textcolor{black}{These processes were modelled using common
...
\begin{sidewaysfigure*}[htbp]
  ...
  \figurenote{This figure shows how LPR (solid black) estimates the
    underlying
    process (dotted black). \textcolor{black}{
...
\begin{figure}[!t]
  ...
  \figurenote{This figure shows how GP regression (solid black) estimates the
    underlying process (dotted black). \textcolor{black}{ Panel (a) shows a
      ...
      posterior distribution. Panels (c) and (d) illustrate the effect of
      fixing
      the lengthscale of the GP prior to values that are too small or too large
      respectively. Panels (e) and (f) illustrate the impact of fixing the
      marginal variance of a GP prior to values that are too small or too large
      resepectively.}
  }
  \label{fig:gp_dem}
\end{figure}
...
\begin{sidewaysfigure*}[htbp]
  ...
  \figurenote{This figure shows how each of the introduced methods inferred an
    example of each of the processes from the simulation. \textcolor{black}{ In
